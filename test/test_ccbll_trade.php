...
$data = [
    ...
    'payType' => 'P', //C:微信APP支付、D:支付宝APP支付、H:一码付（H5二维码）、I:微信扫码支付、J:微信公众号支付、K:建行信用卡分期支付、L:银联在线、M:建行网关对公、N:建行网关对私、P:支付宝扫码、Q:一码付（自定义二维码）、R:龙支付扫码、S:龙支付APP支付
    'mercOrdNo' => 'd0110919091817', //总订单号
